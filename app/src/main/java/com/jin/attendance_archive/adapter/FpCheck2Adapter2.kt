...
class FpCheck2Adapter2(
    private val list: ArrayList<DataWordMovement>,
    private val mCallback: FpFruitsCallback
) : RecyclerView.Adapter<FpCheck2Adapter2.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val label = "[${item.teacher}] ${item.believer}"
        ...
        holder.itemView.setOnClickListener { mCallback.modifyWordMovement(position, item) }
    }
}